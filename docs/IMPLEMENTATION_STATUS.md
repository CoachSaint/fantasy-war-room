...
| Materialization | Candidate branch can persist source-labeled global nflverse actuals, matched evidence, and separate current-week Sleeper forecasts; league-specific scoring, diff, and recommendation materialization remain skipped | Repeatable live Scout run, exact league scoring support, and source-backed actionable recommendations |
