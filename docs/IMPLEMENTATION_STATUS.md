...
| Schema | `0001` through `0005` are aligned on the dedicated project; private schema/data dumps predate `0005`, and disposable owner/outsider availability RLS reads passed | Recheck history before promotion and prove full user/membership isolation with real league data |
